            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input autocomplete="username" type="email" data-testid="employee-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPassword">Mot de passe</label>
                  <input autocomplete="current-password" type="password" data-testid="employee-password-input" class="form-control" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <label for="inputEmail">Votre email</label>
                  <input autocomplete="username" type="email" data-testid="admin-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPassword">Mot de passe</label>
                  <input autocomplete="current-password" type="password" data-testid="admin-password-input" class="form-control" placeholder="******" required>
